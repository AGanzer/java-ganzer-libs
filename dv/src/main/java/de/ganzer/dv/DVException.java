...
/**
 * The base of all exceptions thrown by the DV framework.
 */
public class DVException extends RuntimeException {
     ...
     * @since 1.7
     */
    public DVException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
